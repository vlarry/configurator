...
//    #define DEBUG_REQUEST // отладка отправки/приема данных (отключение синхронизации)
    ...
    class ConfiguratorWindow: public QMainWindow
    {
        ...
        public slots:
            ...
            void automationDisconnectorsRead();
