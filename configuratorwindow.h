...
//            void amplitudeReadOfCurrent();
        ...
        private:
            ...
            bool createProjectTableCalibrationPowerAC(QSqlDatabase *db);
            bool createProjectTableCalibrationBruResistance(QSqlDatabase *db);
            bool createProjectTableCalibrationBruPowerDC(QSqlDatabase *db);
            ...
            void saveDeviceCalibrationPowerAC(QSqlDatabase *db);
            void saveDeviceCalibrationBruResistance(QSqlDatabase *db);
            void saveDeviceCalibrationBruPowerDC(QSqlDatabase *db);
            ...
            void loadDeviceCalibrationPowerAC(QSqlDatabase *db);
            void loadDeviceCalibrationBruResistance(QSqlDatabase *db);
            void loadDeviceCalibrationBruPowerDC(QSqlDatabase *db);
