    ...
    class CWidgetMenu: public QWidget
    {
        ...
        public:
            enum ButtonIDType
            {
                ...
                BUTTON_JOURNAL_SET_EXPORT, // кнопка "Уставок" - открывает подпункты эксорта журнала уставок
                ...
                BUTTON_JOURNAL_SET_IMPORT, // кнопка "Уставок" - открывает подпункты импорта журнала уставок
